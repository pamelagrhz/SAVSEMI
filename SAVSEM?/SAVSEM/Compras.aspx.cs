			...
			case "btnCancelarPR":
				{
					...
					try{
						...
						cmd.CommandText = "INSERT INTO Historial(UsuarioID, Accion, Fecha)" +
							"VALUES (" + Session["ID"].ToString() + ", 'Le canceló el pedido a " + dst.Tables ["Recibidos"].Rows [e.Item.ItemIndex] ["Comprador"].ToString () + " de " + dst.Tables ["Recibidos"].Rows [e.Item.ItemIndex] ["Producto"].ToString () + ".', '" + fecha + "');";
						cmd.ExecuteNonQuery ();
			...
			case "btnCancelarP":
				{
					...
					try{
						...
						cmd.CommandText = "INSERT INTO Historial(UsuarioID, Accion, Fecha)" +
							"VALUES (" + Session["ID"].ToString() + ", 'Canceló el pedido de " + dst.Tables ["Realizados"].Rows [e.Item.ItemIndex] ["Producto"].ToString () + ".', '" + fecha + "');";
						cmd.ExecuteNonQuery ();
